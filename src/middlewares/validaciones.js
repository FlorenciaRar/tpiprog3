...
export const validarReclamosEstado = [
  body("descripcion").notEmpty().withMessage("La descripcion es requerida"),
];

export const validarReclamosTipo = [
  body("descripcion").notEmpty().withMessage("La descripcion es requerida"),
];
...
export const validarReclamos = [
  ...
  body("idReclamoTipo")
    .notEmpty()
    .withMessage("El tipo de reclamo es requerido"),
];

export const validarIdReclamo = [
...
export const validarIdUsuario = [
  param("idUsuario").notEmpty().withMessage("El id del usuario es requerido"),
];
...
export const validarIdEmpleado = [
  param("idEmpleado").notEmpty().withMessage("El id del reclamo es requerido"),
];
...
export const validarAgregarQuitarEmpleado = [
  ...
  body("empleados")
    .isArray({ min: 1 })
    .withMessage("El campo empleados no puede estar vacío"),
];

export const validarCambioEstado = [
  body("idReclamoEstado")
    .notEmpty()
...
export const validarCambioContrasenia = [
  body("contrasenia").notEmpty().withMessage("El campo no puede estar vacío"),
];

export const validarFormatoInforme = [
  query("formato")
    .notEmpty()
    .withMessage("El formato es requerido")
    .isIn(["pdf", "csv", "excel"]) // Reemplaza con los formatos permitidos
    .withMessage("Formato inválido para el informe"),
];

...
// CLIENTES
router.get("/usuario", verificarTipoUsuario([3]), reclamosController.buscarReclamosUsuario
...
router.patch("/cancelacion/:idReclamo/", verificarTipoUsuario([3]), manejarErrores, reclamosController.cancelar
//#swagger.description = 'Cancelar un reclamo por ID'
); // Cancelar un reclamo

// EMPLEADOS
router.get("/oficina", verificarTipoUsuario([2]), reclamosController.buscarReclamosOficina
//#swagger.description = 'Reclamos por empleado'
); //Reclamos por empleado

router.patch("/estado/:idReclamo/", verificarTipoUsuario([2]), validarCambioEstado, manejarErrores, reclamosController.cambiarEstado
